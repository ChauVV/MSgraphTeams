...
const config: AuthConfiguration = {
  ...
  serviceConfiguration: {
    authorizationEndpoint:
      'https://login.microsoftonline.com/cb49b5e3-5da4-49a2-b315-f8234af61e14/oauth2/v2.0/authorize',
    tokenEndpoint:
      'https://login.microsoftonline.com/cb49b5e3-5da4-49a2-b315-f8234af61e14/oauth2/v2.0/token',
  },
};
...
export class AuthManager {
  static signInAsync = async () => {
    ...
    console.log('authen: ', result, result.accessToken);
